...
description: "File watchers and event triggers that connect your vault to AI agents. A hook watches for changes and automatically fires the right agent — no buttons, no commands."
reading_time: "5 min"
publish: true
date: 2026-07-09
type: showcase
