---
title: "Dativ Präpositionen — Der vollständige Guide"
date: 2026-08-04
tags:
  - deutsch
  - grammatik
...
```mermaid
flowchart TD
    START["Dativ-Präposition?"]

    START --> Q1{"Woher?<br>Herkunft / Material?"}
    Q1 -->|"Land, Stadt, Ort"| AUS["aus<br><i>Ich komme aus Berlin.</i>"]
    Q1 -->|"Material"| AUS
    Q1 -->|"Ursprung / Besitz"| VON["von<br><i>Das Buch ist von Goethe.</i>"]
    Q1 -->|"nein"| Q2{"Wann?<br>Zeit?"}

    Q2 -->|"Beginn<br>(ab wann?)"| AB["ab<br><i>Ab morgen bin ich im Urlaub.</i>"]
    Q2 -->|"Dauer bis jetzt<br>(seit wann?)"| SEIT["seit<br><i>Ich wohne hier seit 2020.</i>"]
    Q2 -->|"nach einem<br>Ereignis"| NACH["nach<br><i>Nach dem Essen schlafe ich.</i>"]
    Q2 -->|"nein"| Q3{"Wo?<br>Ort / Position?"}

    Q3 -->|"bei Person / Firma"| BEI["bei<br><i>Ich arbeite bei Siemens.</i>"]
    Q3 -->|"gegenüber"| GEGEN["gegenüber<br><i>Das Café ist gegenüber der Post.</i>"]
    Q3 -->|"nein"| Q4{"Wohin?<br>Richtung / Ziel?"}

    Q4 -->|"Stadt / Land<br>(ohne Artikel)"| NACH2["nach<br><i>Ich fahre nach Berlin.</i>"]
    Q4 -->|"Person / Ort mit<br>Artikel / Anlass"| ZU["zu<br><i>Ich gehe zum Arzt.</i>"]
    Q4 -->|"nein"| Q5{"Womit? / Mit wem?<br>Mittel / Begleitung?"}

    Q5 -->|"Transport / Werkzeug"| MIT["mit<br><i>Ich fahre mit dem Bus.</i>"]
    Q5 -->|"Begleitung"| MIT
    Q5 -->|"nein"| Q6{"Ausnahme /<br>Ausschluss?"}

    Q6 -->|"außer / except"| AUSSER["außer<br><i>Alle außer mir waren da.</i>"]
    Q6 -->|"nein"| UNKNOWN["Andere Präposition<br>(Akkusativ / Wechsel / Genitiv)"]

    style START fill:#4a90d9,color:#fff
    style AUS fill:#0d47a1,color:#fff
    style VON fill:#0d47a1,color:#fff
    style AB fill:#0d47a1,color:#fff
    style SEIT fill:#0d47a1,color:#fff
    style NACH fill:#0d47a1,color:#fff
    style NACH2 fill:#0d47a1,color:#fff
    style BEI fill:#0d47a1,color:#fff
    style GEGEN fill:#0d47a1,color:#fff
    style ZU fill:#0d47a1,color:#fff
    style MIT fill:#0d47a1,color:#fff
    style AUSSER fill:#0d47a1,color:#fff
    ...
    style Q4 fill:#fff3e0,stroke:#ff9800,stroke-width:2px
    style Q5 fill:#fff3e0,stroke:#ff9800,stroke-width:2px
